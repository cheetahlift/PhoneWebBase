package com.guangzhou.pcsold.generator;
...
public class TCodeGenerator {
    ...
    /**数据库地址*/
    public static String DB_URL = "jdbc:mysql://localhost:3306/pcsold?characterEncoding=utf8&useSSL=false&serverTimezone=UTC";
    /**数据库驱动名*/
    ...
    /**参与逆向工程的表名**/
    public static String[] INCLUDE_TABLE_NAMES = new String[]{"user","address","goods","image","orders","ordersdetail","payinfo","shoppingcar"};
    /**不参与逆向工程的表名**/
    public static String[] EXCLUDE_TABLE_NAMES = new String[]{"spatial_ref_sys"};
    /**创建人*/
    public static String AUTHOR = "ljs";
    /**表字段生成对应的实体类时，字段属性是否需要强制带上注解*/
    public static boolean ENABLE_TABLE_FIELD_ANNOTATION = true;
...
//                .setExclude(EXCLUDE_TABLE_NAMES)
    ...
    private static TemplateConfig TemplateGenerate(){
        TemplateConfig templateConfig = new TemplateConfig()
                .setController("/templates/code-template/controller.java")
                .setMapper("/templates/code-template/mapper.java")
                .setXml("/templates/code-template/mapper.xml")
                .setEntity("/templates/code-template/entity.java")
                .setService("/templates/code-template/service.java")
                .setServiceImpl("/templates/code-template/serviceImpl.java");
        return templateConfig;
    }

    public static PackageConfig PackageGenerate(){
        PackageConfig pc = new PackageConfig()
                .setParent("com.guangzhou.pcsold")
    ...
    public void generateByTablesWithInjectConfig() {
        ...
        //自定义代码配置
        TemplateConfig templateConfig = TCodeGenerator.TemplateGenerate();
